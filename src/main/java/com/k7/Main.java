...
//        }
//        System.out.println("----------------------------");
       // viewer.viewContact(finder.searchContact("11"), phones.getAllPhones());
        bookControl.autoAddContacts();
        bookControl.showContacts();
        //bookControl.searchContactByName("V");
        //bookControl.searchContactByPhone("11");
        //bookControl.createContact("Maxа","0633213131","fax");
        //bookControl.addPhoneToContact("Ma","0633213131","fax");
        //bookControl.deleteContact("Alex");
        bookControl.showContacts();
